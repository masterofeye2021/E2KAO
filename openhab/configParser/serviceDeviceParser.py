...
class ServiceDeviceParser(GenericParser):
    ...
    def loadSheet(self) -> None:
        # @todo magix number
        self.sheet = self.workbook["SERVICES"]
    ...
    def readItems(self) -> None:
        for row in self.sheet.iter_rows(min_row=2, values_only=True):
            ...
            self.items.append(Item(OpenhabItemType(row[NetworkMapping.TYPE]), "_".join(filter(bool, [
                ...
                None,
                None,
                OpenhabBinding(OpenhabBindingType.SERVICE_ONLINE),
            ...
            self.items.append(Item(OpenhabItemType.DATETIME, "_".join(filter(bool, [
                ...
                None,
                None,
                OpenhabBinding(OpenhabBindingType.SERVICE_LAST_SEEN),
                ""
            ))
